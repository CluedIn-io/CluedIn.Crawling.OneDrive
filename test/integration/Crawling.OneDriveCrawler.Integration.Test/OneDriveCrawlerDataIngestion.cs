...
{
    public class DataIngestion : IClassFixture<OneDriveCrawlerTestFixture>
    {
        private readonly OneDriveCrawlerTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(OneDriveCrawlerTestFixture fixture, ITestOutputHelper output)
        {
