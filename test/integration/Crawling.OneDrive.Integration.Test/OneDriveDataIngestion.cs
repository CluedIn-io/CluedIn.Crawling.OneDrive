...
{
    public class DataIngestion : IClassFixture<OneDriveTestFixture>
    {
        private readonly OneDriveTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(OneDriveTestFixture fixture, ITestOutputHelper output)
        {
