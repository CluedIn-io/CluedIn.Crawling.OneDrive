...
{
    public class OneDriveCrawler_Command_MeshProcessor : BaseMeshProcessor
    {
        public OneDriveCrawler_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          OneDriveCrawlerConstants.ProviderId;
